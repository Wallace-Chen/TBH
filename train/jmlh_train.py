...
def train(set_name, bbn_dim, batch_size, max_iter=100000):
    ...
    for i in range(max_iter):
        with writer.as_default():
            ...
            if (i + 1) % 100 == 0:
                train_hook,_,_ = eval_cls_map(train_code, train_code, train_label, train_label)
            ...
            if (i + 1) % 2000 == 0:
                ...
                test_hook,_,_ = eval_cls_map(test_code, data.train_code, test_label, data.train_label, at=1000)
